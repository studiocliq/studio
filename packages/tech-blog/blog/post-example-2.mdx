...
tags: ['HELLO', 'HI']
featuredImage: './post-example-2.jpg'
---
...
Object는 컨텐츠가 렌더링될 부분을 지정하는 역할을 한다. Double curly braces({{, }})를 통해 표현한다.
...
템플릿을 위한 산술, 논리 연산을 생성한다. {%, %}로 사용된다. 일반적인 프로그래밍 언어의 조건, 제어문과 같은 역할을 수행한다.
